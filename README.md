...
- Solution URL: [Solution URL here](https://github.com/JulianLivrone/Order-summary-component)
- Live Site URL: [Live site URL here](https://julianlivrone.github.io/Order-summary-component/)
...
This project was quite interesting, most of it was pretty standard card creation, but the challenge was to center the svg without it being cropped. Also the hover effects where really interesting to make. Good project overall.
